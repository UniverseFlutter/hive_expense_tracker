...
import 'package:hive_expense_tracker/boxes.dart';
import 'package:hive_expense_tracker/model/transaction.dart';
import 'package:hive_expense_tracker/widget/transaction_dialog.dart';
...
class _TransactionPageState extends State<TransactionPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          title: Text('Моніторинг доходів та витрат'),
          centerTitle: true,
        ),
  ...
  Widget buildTransaction(
    ...
    late final amount = '\$' + transaction.amount.toStringAsFixed(2);
